...
export default function Bank({actionMethod,info,data}){
    ...
    return(
        ...
        <Form.Item
            label={<p className=" text-left m-0 w-96 ">Account Number</p>}
            name ="account_number"
        ...
        <Form.Item
            ...
            name ="adhaar_number"
            rules={[{required:true, message: 'Aadhaar Card Number is required!'}]}>
            <InputNumber placeholder='Adhaar Number' maxLength={12}/>
        </Form.Item>
        <Form.Item
